                    ...
                    if((current->PCRdate)<currDay){//if PCR tested since yesterday
                        if(current->COVID==1){
                            ...
                            if(lockLocation==1){ //min
                                (*pLockdownMinUnit)[lockPrison][lockArea][lockUnit]=1;
                            ...
                            while(lockCurrent!=NULL){
                                if(lockCurrent->location==lockLocation){ //if same location
                                    if(lockCurrent->zone==lockPrison&&lockCurrent->locArea==lockArea&&lockCurrent->locUnit==lockUnit){ //if same prison
    ...
    for(ctr=0; ctr<lMinZone; ctr++){
                ...
                if(current->zone==ctr){ //This should be checking againts ctr. Check prison lockdown code
                            if(current->lockdown==1){
                                if(current->COVID==1){
                                    ...
                                    tempMinUnit[ctr][targetArea][targetUnit]=1;//fill flag array (*flagLockdownMaxArea)[ctr][actr]= temp variable
                                }
                            }
                }
            }
        ...
        for(actr=0; actr<lMinArea; actr++){
            ...
            for(uctr=0; uctr<lMinUnit; uctr++){
                ...
                prevState=(*pLockdownMinUnit)[ctr][actr][uctr];
                
                if (tempMinUnit[ctr][actr][uctr]==0&&prevState==1) { // then Unlock
                    current=*pHeadCopy;
                    //if(infFlag==0){
                        //iterate through all
                        while(current!=NULL){
                            if(current->location==1){
                                if(current->zone==ctr&&current->locArea==actr&&current->locUnit==uctr){
                                    if(current->lockdown==1){
                        ...
                        //set lockdown to 0
                        (*pLockdownMinUnit)[ctr][actr][uctr]=0;
                    //}
                }
    ...
    for(ctr=0; ctr<lMedZone; ctr++){
                ...
                if(current->zone==ctr){ //This should be checking againts ctr. Check prison lockdown code
                            if(current->lockdown==1){
                                if(current->COVID==1){
                                    targetArea=current->locArea;
                                    targetUnit=current->locUnit;
                                    tempMedUnit[ctr][targetArea][targetUnit]=1;//fill flag array (*flagLockdownMaxArea)[ctr][actr]= temp variable
                                }
                            }
                }
            }
        ...
        for(actr=0; actr<lMedArea; actr++){
            for(uctr=0; uctr<lMedUnit; uctr++){
                prevState=(*pLockdownMedUnit)[ctr][actr][uctr];
             
                if (tempMedUnit[ctr][actr][uctr]==0&&prevState==1) { // then Unlock
                    current=*pHeadCopy;
                    //if(infFlag==0){
                        //iterate through all
                        while(current!=NULL){
                        ...
                        //set lockdown to 0
                        (*pLockdownMedUnit)[ctr][actr][uctr]=0;
                    //}
                }
    ...
    for(ctr=0; ctr<lMaxZone; ctr++){
                ...
                if(current->zone==ctr){ //This should be checking againts ctr. Check prison lockdown code
                            if(current->lockdown==1){
                                if(current->COVID==1){
                                    targetArea=current->locArea;
                                    targetUnit=current->locUnit;
                                    tempMaxUnit[ctr][targetArea][targetUnit]=1;//fill flag array (*flagLockdownMaxArea)[ctr][actr]= temp variable
                                }
                            }
                }
            }
        ...
        for(actr=0; actr<lMaxArea; actr++){
            for(uctr=0; uctr<lMaxUnit; uctr++){
                prevState=(*pLockdownMaxUnit)[ctr][actr][uctr];
                ...
                if (tempMedUnit[ctr][actr][uctr]==0&&prevState==1) { // then Unlock
                    ...
                    //if(infFlag==0){
                        ...
                        //set lockdown to 0
                        (*pLockdownMaxUnit)[ctr][actr][uctr]=0;
                    //}
                }
