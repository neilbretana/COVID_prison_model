...
int rapidTestInmate(gsl_rng **r, sIndiv **pTarget, int currDay, int *PSTP, int *PSTN, int *PSFP, int *PSFN);
							...
							printf("PERFORM!\n");
            				 switch(iCrawl){
                                 ...
                                 case 1://move to prison 1
                                     printf("case 1\n");
                                     if(target->indivType==0){
                                         ratMoveFlag=rapidTestInmate(&r, &target, currDay, &totalPSTP, &totalPSTN, &totalPSFP, &totalPSFN);
                                         if(ratMoveFlag==0){
